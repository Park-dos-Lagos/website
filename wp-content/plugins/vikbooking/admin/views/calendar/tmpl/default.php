	...
	<div class="vbo-calendar-cfields-filler">
		<div class="vbo-calendar-cfields-topcont">
			<div class="vbo-calendar-cfields-search">
				<label for="vbo-searchcust"><?php echo JText::_('VBOSEARCHEXISTCUST'); ?></label>
				<span id="vbo-searchcust-loading">
					<i class="vboicn-hour-glass"></i>
				</span>
				<input type="text" id="vbo-searchcust" autocomplete="off" value="" placeholder="<?php echo htmlspecialchars(JText::_('VBOSEARCHCUSTBY')); ?>" size="35" />
