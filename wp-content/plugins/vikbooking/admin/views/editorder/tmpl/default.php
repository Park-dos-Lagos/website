													...
													<div class="vbo-param-container">
														...
														<div class="vbo-param-setting">
															...
															<span class="vbo-param-setting-comment">
																<?php echo JText::_('VBOCUSTOMERCMMSONTOTAL') . ' ' . $currencysymb . ' ' . VikBooking::numberFormat($row['total']) . ' - ' . JText::_('VBAMOUNTPAID') . ' ' . $currencysymb . ' ' . VikBooking::numberFormat($row['totpaid']); ?>
															</span>
														</div>
													</div>
													<div class="vbo-param-container">
													...
													<div class="vbo-params-block">
														<div class="vbo-param-container">
															...
															<div class="vbo-param-setting">
																...
																<span class="vbo-param-setting-comment"><?php echo JText::_('VBEDITORDERNINE') . ' ' . $currencysymb . ' ' . VikBooking::numberFormat($row['total']); ?></span>
															</div>
														</div>
														<div class="vbo-param-container">
															<div class="vbo-param-label">
