	...
	if ((count($rows) * $mnum) > 10) {
		...
		<div class="btn-group pull-left">
			<select name="stickytheads" onchange="vboToggleStickyTableHeaders(this.value);">
				<optgroup label="<?php echo JHtml::_('esc_attr', JText::_('VBO_LAYOUT')); ?>">
					<option value="1"<?php echo empty($cookie_sticky_heads) || $cookie_sticky_heads == 'on' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBO_TABLE'); ?></option>
					<option value="0"<?php echo $cookie_sticky_heads == 'off' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBO_SCROLL'); ?></option>
				</optgroup>
			</select>
		</div>
		<?php
