				...
				if (!$details['closure']) {
					...
					<div class="vbo-params-fieldset vbo-widget-bookdets-history-list">
						...
						foreach ($history_list as $hind => $hist) {
							...
							$tip_info = [
								JText::_('VBOBOOKHISTORYLBLTOT') . ': ' . $currencysymb . ' ' . VikBooking::numberFormat($hist['total']),
								JText::_('VBOBOOKHISTORYLBLTPAID') . ': ' . $currencysymb . ' ' . VikBooking::numberFormat($hist['totpaid']),
							];
							?>
