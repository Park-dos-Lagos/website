					...
					<div class="vbo-customer-info-box">
						...
						if (!empty($notif->customer_pic)) {
							...
							<span class="vbo-widget-notifscenter-cpic-zoom">
								<img src="<?php echo strpos($notif->customer_pic, 'http') === 0 ? $notif->customer_pic : VBO_SITE_URI . 'resources/uploads/' . $notif->customer_pic; ?>" data-caption="<?php echo JHtml::_('esc_attr', (string) $notif->customer_name); ?>" />
							</span>
							<?php
