		...
		<div class="vbo-calendar-cfields-filler" data-wrapper="<?php echo $wrapper; ?>">
			<div class="vbo-calendar-cfields-topcont">
				<div class="vbo-calendar-cfields-search">
					<label for="vbo-searchcust<?php echo $wrapper; ?>"><?php echo JText::_('VBOSEARCHEXISTCUST'); ?></label>
					<span id="vbo-searchcust-loading<?php echo $wrapper; ?>" class="vbo-searchcust-loading">
						<i class="vboicn-hour-glass"></i>
					</span>
					<input type="text" id="vbo-searchcust<?php echo $wrapper; ?>" class="vbo-searchcust" autocomplete="off" value="" placeholder="<?php echo htmlspecialchars(JText::_('VBOSEARCHCUSTBY')); ?>" size="35" />
