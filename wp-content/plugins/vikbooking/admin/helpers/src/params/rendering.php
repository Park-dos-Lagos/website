    ...
    public function getField($param_name, $param_config)
    {
        ...
        switch ($param_config['type']) {
            ...
            case 'password':
                ...
                $html .= '<input type="password" name="' . $this->inputName . '[' . $param_name . ']" value="'.(isset($this->settings[$param_name]) ? JHtml::_('esc_attr', $this->settings[$param_name]) : JHtml::_('esc_attr', $default_paramv)).'" size="20"' . $inp_attr . '/>';
