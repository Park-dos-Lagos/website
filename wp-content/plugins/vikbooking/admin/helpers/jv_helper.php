...
JS
	...
	public function loadDatePicker(array $options = [])
	{
		...
		$vbo_dp_regional_vals = [
			...
			'monthNamesShort' => [
				$this->safeSubstr(JText::_('VBMONTHONE')),
				$this->safeSubstr(JText::_('VBMONTHTWO')),
				$this->safeSubstr(JText::_('VBMONTHTHREE')),
				$this->safeSubstr(JText::_('VBMONTHFOUR')),
				$this->safeSubstr(JText::_('VBMONTHFIVE')),
				$this->safeSubstr(JText::_('VBMONTHSIX')),
				$this->safeSubstr(JText::_('VBMONTHSEVEN')),
				$this->safeSubstr(JText::_('VBMONTHEIGHT')),
				$this->safeSubstr(JText::_('VBMONTHNINE')),
				$this->safeSubstr(JText::_('VBMONTHTEN')),
				$this->safeSubstr(JText::_('VBMONTHELEVEN')),
				$this->safeSubstr(JText::_('VBMONTHTWELVE')),
			],
			'dayNames' => [
			...
			'dayNamesShort' => [
				$this->safeSubstr(JText::_('VBWEEKDAYZERO')),
				$this->safeSubstr(JText::_('VBWEEKDAYONE')),
				$this->safeSubstr(JText::_('VBWEEKDAYTWO')),
				$this->safeSubstr(JText::_('VBWEEKDAYTHREE')),
				$this->safeSubstr(JText::_('VBWEEKDAYFOUR')),
				$this->safeSubstr(JText::_('VBWEEKDAYFIVE')),
				$this->safeSubstr(JText::_('VBWEEKDAYSIX')),
			],
			'dayNamesMin' => [
				$this->safeSubstr(JText::_('VBWEEKDAYZERO'), $day_names_min_len),
				$this->safeSubstr(JText::_('VBWEEKDAYONE'), $day_names_min_len),
				$this->safeSubstr(JText::_('VBWEEKDAYTWO'), $day_names_min_len),
				$this->safeSubstr(JText::_('VBWEEKDAYTHREE'), $day_names_min_len),
				$this->safeSubstr(JText::_('VBWEEKDAYFOUR'), $day_names_min_len),
				$this->safeSubstr(JText::_('VBWEEKDAYFIVE'), $day_names_min_len),
				$this->safeSubstr(JText::_('VBWEEKDAYSIX'), $day_names_min_len),
			],
